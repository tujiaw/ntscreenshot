...
inline BOOL IsRectEmpty(RECT r)
{
...
private:
    inline static HWND m_hWndTarget = NULL;
    inline static HWND m_hWndFilter = NULL;
    inline static std::vector<HWndCacheInfo> m_cacheList;
};
