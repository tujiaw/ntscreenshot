...
public:
	...
	//! Returns the last registration/unregistration error message, or an empty
	//! string if the last call succeeded. Useful for surfacing the OS-level
	//! reason (e.g. "hot key already registered") to the user.
