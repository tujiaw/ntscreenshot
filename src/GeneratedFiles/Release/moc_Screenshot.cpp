...
QT_MOC_LITERAL(12, 131, 12), // "onSaveScreen"
QT_MOC_LITERAL(13, 144, 17), // "onSaveScreenOther"
QT_MOC_LITERAL(14, 162, 14) // "quitScreenshot"
    ...
    "x\0y\0onSticker\0onSaveScreen\0onSaveScreenOther\0"
    "quitScreenshot"
};
#undef QT_MOC_LITERAL
...
void SelectedScreenWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: _t->onSaveScreen(); break;
        case 9: _t->onSaveScreenOther(); break;
        case 10: _t->quitScreenshot(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
