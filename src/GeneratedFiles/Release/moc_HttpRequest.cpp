...
QT_MOC_LITERAL(1, 12, 15), // "sigHttpResponse"
...
QT_MOC_LITERAL(7, 67, 9), // "slotError"
QT_MOC_LITERAL(8, 77, 27) // "QNetworkReply::NetworkError"

    },
    "HttpRequest\0sigHttpResponse\0\0err\0data\0"
    "replyFinished\0QNetworkReply*\0slotError\0"
...
void HttpRequest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigHttpResponse((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QByteArray(*)>(_a[2]))); break;
        ...
        {
            typedef void (HttpRequest::*_t)(int , const QByteArray & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HttpRequest::sigHttpResponse)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void HttpRequest::sigHttpResponse(int _t1, const QByteArray & _t2)
{
