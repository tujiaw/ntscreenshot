...
QT_MOC_LITERAL(1, 12, 8), // "sigClose"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "TitleWidget\0sigClose\0"
};
...
void TitleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TitleWidget::sigClose)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject TitleWidget::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_TitleWidget.data,
