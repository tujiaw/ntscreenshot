...
void WindowManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WindowManager::sigPin)) {
                *result = 0;
                return;
            }
        }
        ...
        {
            typedef void (WindowManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WindowManager::sigStickerCountChanged)) {
                *result = 2;
                return;
            }
        }
